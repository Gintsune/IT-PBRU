...
public class MainActivity extends AppCompatActivity {
    ...
    }   //clickSignIn ทำงานเมื่อกด signin
    ...
    private void checkUserAnPassword() {
        ...
        try {
            SQLiteDatabase sqLiteDatabase = openOrCreateDatabase(MyOpenHelper.database_name,
                    MODE_PRIVATE, null);
            Cursor cursor = sqLiteDatabase.rawQuery("SELECT * FROM userTABLE WHERE User ="+"'"+userString
                    +"'", null);
            cursor.moveToFirst();
            ...
            MyAlert myAlert = new MyAlert();
            myAlert.myDialog(this, "ไม่มี User ไอสลัด", "ไม่มี" + userString + "ในฐานข้อมูลของเรา");
